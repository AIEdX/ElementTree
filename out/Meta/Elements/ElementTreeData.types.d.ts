...
export declare type ElementTypes = "fragment" | "div" | "span" | "pre" | "code" | "embed" | "object" | "param" | "picture" | "source" | "audio" | "video" | "track" | "img" | "svg" | "ul" | "ol" | "li" | "nav" | "article" | "aside" | "section" | "header" | "footer" | "form" | "input" | "label" | "textarea" | "select" | "option" | "optiongroup" | "datalist" | "button" | "hr" | "a" | "canvas" | "iframe" | "table" | "th" | "thead" | "tbody" | "colgroup" | "tr" | "td" | "component" | "text" | "p" | "h1" | "h2" | "h3" | "h4" | "h5" | "h6";
